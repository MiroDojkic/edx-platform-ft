...
# Geocoding
GEOCODING_API_KEY = ENV_TOKENS.get('GEOCODING_API_KEY')
...
WORKSPACE_URL = ENV_TOKENS.get('WORKSPACE_URL', WORKSPACE_URL)
FASTTRAC_COURSE_KEY = ENV_TOKENS.get('FASTTRAC_COURSE_KEY', FASTTRAC_COURSE_KEY)

SG_PRESURVEY_URL = ENV_TOKENS.get('SG_PRESURVEY_URL')

MAILCHIMP_LIST_ID = ENV_TOKENS.get('MAILCHIMP_LIST_ID')
MAILCHIMP_API_KEY = ENV_TOKENS.get('MAILCHIMP_API_KEY')

PAYMENT_PREVIEW = ENV_TOKENS.get('PAYMENT_PREVIEW', False)

# Auth0 management API config
AUTH0_DOMAIN_URL = ENV_TOKENS.get('AUTH0_DOMAIN_URL')
AUTH0_CLIENT_ID = ENV_TOKENS.get('AUTH0_CLIENT_ID')
AUTH0_CLIENT_SECRET = ENV_TOKENS.get('AUTH0_CLIENT_SECRET')
AUTH0_AUDIENCE = ENV_TOKENS.get('AUTH0_AUDIENCE')
AUTH0_CONNECTION_ID = ENV_TOKENS.get('AUTH0_CONNECTION_ID')
